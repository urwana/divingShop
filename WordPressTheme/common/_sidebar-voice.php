<div class="sidebar-voice">
  <?php get_template_part("./_sidebar-title", null,  ["title" => "口コミ", "className" => "sidebar-voice__title"]) ?>
  <?php
  $voiceCardData = [
    ...
    "imgPathSp" => "./assets/images/blog/sidebar-voice.jpg", "alt" => "20代(女性)の画像",
  ...
  <div class="sidebar-voice__card">
    <?php get_template_part("./_voice-card-sidebar", null, ["voiceCardData" => $voiceCardData]) ?>
  </div>
</div>