      ...
      <div class="top-contact__conntents">
        <div class="top-contact__info">
          <div class="top-contact-logo__container">
            <figure class="top-contact-logo">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/logo-contact.svg"
        ...
        <div class="top-contact__contact">
          ...
          <div class="top-contact__button-container">
            <a href="<?php echo esc_url(home_url("/contact")); ?>" class="button"><span class="button__text">Contact
                us</span></a>
          </div>
        </div>
      </div>
    ...
    <div class="footer__inner inner">
      <div class="footer__images-container">
        ...
        <div class="footer__sns-icons sns-icons">
          ...
          <a href="<?php echo esc_url("https://www.instagram.com/"); ?>" target=”_blank” class="sns-icons__link">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/icon-instagram.svg"
              alt="Instagram" width="24" height="24" />
          </a>
          <a href="<?php echo esc_url("https://x.com/"); ?>" target=”_blank” class=" sns-icons__link
