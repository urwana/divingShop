  ...
  <div class="about__inner inner <?php echo $top ? "" : "about__inner--fish about__inner--page" ?>">
    ...
    <div class="about__image-container<?php echo $top ? "" : " about__image-container--page" ?>">
      <figure class="about__image-left">
        <picture>
          <source media="(max-width: 767px)" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/top/bg-about-sp-left.jpg" />
      ...
      <figure class="about__image-right">
        <picture>
          <source media="(max-width: 767px)" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/top/bg-about-sp-right.jpg" />
