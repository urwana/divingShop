    ...
    <?php foreach ($informationTabData as $index => $tabData) { ?>
      <div class="tab-contents-information__item js-information<?php echo $index === 0 ? " current" : "" ?>">
        <img src="<?php echo get_template_directory_uri();
                  echo isset($tabData["imagePath"]) ? $tabData["imagePath"] : [] ?>.svg" alt="<?php echo isset($tabData["alt"]) ? $tabData["alt"] : [] ?>" class="u-desktop" width="48" height="48" />
        <?php echo isset($tabData["text"]) ? isset($tabData["text"]) : [] ?><br class="u-mobile" /><?php echo isset($tabData["text2"]) ? $tabData["text2"] : [] ?>
      </div>
    <?php }; ?>
  </div>
        ...
        <div class="tab-contents-information__content">
          ...
          <figure class="tab-contents-information__img">
            <picture>
              ...
              <img src="<?php echo get_template_directory_uri();
                        echo $tabContents["imagePath"] ?>-pc.jpg" alt="<?php echo $tabContents["alt"] ?>" width="492" height="313" />
            </picture>
          </figure>
        </div>
      </div>
