<form action="" method="post" id="">
  <div class="contact-form">
    ...
    <dl class="contact-form__row">
      ...
      <dd class="contact-form__item">
        <label class="contact-form__label"><input type="radio" name="target" value="ダイビング講習について" checked /><span class="contact-form__label-text">ダイビング講習について</span></label>
        <label class="contact-form__label"><input type="radio" name="target" value="ファンデイビングについて" /><span class="contact-form__label-text">ファンデイビングについて</span></label>
        <label class="contact-form__label"><input type="radio" name="target" value="体験ダイビングについて" /><span class="contact-form__label-text">体験ダイビングについて</span></label>
      </dd>
    </dl>
    <dl class="contact-form__row">
    ...
    <dl class="contact-form__row">
      <dt class="contact-form__title">お問合せ内容 <?php get_template_part("./_require-label") ?></dt>
      <dd class="contact-form__item">
