      ...
      <div class="top-tour__inner inner">
        <div class="top-tour__title">
          <div class="section-title">
            ...
            <h2 class="section-title__japan">ツアー</h2>
          </div>
        </div>
      ...
      <div class="top-information__inner inner">
        <div class="top-information__title">
          <div class="section-title">
            ...
            <h2 class="section-title__japan">アクティビティー情報</h2>
          </div>
        </div>
        <div class="top-information__contents">
          ...
          <div class="top-information__info">
            <div class="top-information__info-title">
              <div class="lined-title lined-title--medium">各種スクール</div>
            </div>
            <p class="top-information__text">
              当社には、ダイビングライセンス（Cカード）世界最大の教育機関PADIの認証など様々な資格を取得したスタッフが多数在籍しています。<br />
              サップ、シュノーケリング、ダイビングなどあらゆるマリンスポーツを安全に楽しく習得できます。
            </p>
    ...
    <div class="top-voice">
      <div class="top-voice__inner inner">
        <div class="top-voice__title">
          <div class="section-title">
            <p class="section-title__word">Stay & Eat</p>
            <h2 class="section-title__japan">泊まる・食べる</h2>
          </div>
        </div>
