...
function rename_default_post_type_labels()
{
  $post_type = get_post_type_object('post');
  if (!$post_type) return; // 安全対策
...
add_action('init', 'rename_default_post_type_labels');

function rename_default_post_type_menu()
{
  global $menu, $submenu;
  $menu[5][0] = 'Spot';
  $submenu['edit.php'][5][0] = 'Spot一覧';
  $submenu['edit.php'][10][0] = '新規Spotを追加';
  $submenu['edit.php'][15][0] = 'タグ';
}
add_action('admin_menu', 'rename_default_post_type_menu');
