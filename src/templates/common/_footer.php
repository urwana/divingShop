  ...
  <div class="footer__inner inner">
    <div class="footer__images-container">
      <figure class="footer__logo">
        <img src="./assets/images/common/logo.svg" alt="codeUps コードアップスのロゴ" width="200" height="75" />
      </figure>
      <div class="footer__sns-icons sns-icons">
        <a href="/facebook" class="sns-icons__link">
          <img src="./assets/images/common/icon-facebook.svg" alt="Facebook" width="24" height="24" />
        </a>
        <a href="/instagram" class="sns-icons__link">
          <img src="./assets/images/common/icon-instagram.svg" alt="Instagram" width="24" height="24" />
        </a>
        <a href="/x" class="sns-icons__link sns-icons__link--twitter">
          <img src="./assets/images/common/icon-twitter.svg" alt="Twitter" width="24" height="24" />
        </a>
      </div>
    </div>
